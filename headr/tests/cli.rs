...
fn gen_bad_file() -> String {
    loop {
        let filename: String = random_string();
...
#[test]
fn dies_bad_lines_and_bytes() -> TestResult {
    let expected = "The argument '--lines <LINES>' cannot be used with '--bytes <BYTES>'";
...
fn empty_n2() -> TestResult {
    run(&["-n", "2", EMPTY], "tests/expected/empty.txt.n2.out")
}

#[test]
fn empty_n4() -> TestResult {
    run(&["-n", "4", EMPTY], "tests/expected/empty.txt.n4.out")
}

#[test]
fn empty_c1() -> TestResult {
    run(&["-c", "1", EMPTY], "tests/expected/empty.txt.c1.out")
}

#[test]
fn empty_c2() -> TestResult {
    run(&["-c", "2", EMPTY], "tests/expected/empty.txt.c2.out")
}

#[test]
fn empty_c4() -> TestResult {
    run(&["-c", "4", EMPTY], "tests/expected/empty.txt.c4.out")
}
...
fn one_n2() -> TestResult {
    run(&["-n", "2", ONE], "tests/expected/one.txt.n2.out")
}

#[test]
fn one_n4() -> TestResult {
    run(&["-n", "4", ONE], "tests/expected/one.txt.n4.out")
}

#[test]
fn one_c1() -> TestResult {
    run(&["-c", "1", ONE], "tests/expected/one.txt.c1.out")
}

#[test]
fn one_c2() -> TestResult {
    run(&["-c", "2", ONE], "tests/expected/one.txt.c2.out")
}

#[test]
fn one_c4() -> TestResult {
    run(&["-c", "4", ONE], "tests/expected/one.txt.c4.out")
}
...
fn two_n2() -> TestResult {
    run(&["-n", "2", TWO], "tests/expected/two.txt.n2.out")
}

#[test]
fn two_n4() -> TestResult {
    run(&["-n", "4", TWO], "tests/expected/two.txt.n4.out")
}

#[test]
fn two_c1() -> TestResult {
    run(&["-c", "1", TWO], "tests/expected/two.txt.c1.out")
}

#[test]
fn two_c2() -> TestResult {
    run(&["-c", "2", TWO], "tests/expected/two.txt.c2.out")
}

#[test]
fn two_c4() -> TestResult {
    run(&["-c", "4", TWO], "tests/expected/two.txt.c4.out")
}
...
fn three_n2() -> TestResult {
    run(&["-n", "2", THREE], "tests/expected/three.txt.n2.out")
}

#[test]
fn three_n4() -> TestResult {
    run(&["-n", "4", THREE], "tests/expected/three.txt.n4.out")
}

#[test]
fn three_c1() -> TestResult {
    run(&["-c", "1", THREE], "tests/expected/three.txt.c1.out")
}

#[test]
fn three_c2() -> TestResult {
    run(&["-c", "2", THREE], "tests/expected/three.txt.c2.out")
}

#[test]
fn three_c4() -> TestResult {
    run(&["-c", "4", THREE], "tests/expected/three.txt.c4.out")
}
...
fn ten_n2() -> TestResult {
    run(&["-n", "2", TEN], "tests/expected/ten.txt.n2.out")
}

#[test]
fn ten_n4() -> TestResult {
    run(&["-n", "4", TEN], "tests/expected/ten.txt.n4.out")
}

#[test]
fn ten_c1() -> TestResult {
    run(&["-c", "1", TEN], "tests/expected/ten.txt.c1.out")
}

#[test]
fn ten_c2() -> TestResult {
    run(&["-c", "2", TEN], "tests/expected/ten.txt.c2.out")
}

#[test]
fn ten_c4() -> TestResult {
    run(&["-c", "4", TEN], "tests/expected/ten.txt.c4.out")
}
...
#[test]
fn all_n2() -> TestResult {
    run(
        &["-n", "2", EMPTY, ONE, TWO, THREE, TEN],
        "tests/expected/all.n2.out",
    )
}

#[test]
fn all_n4() -> TestResult {
    run(
...
#[test]
fn all_c1() -> TestResult {
    run(
        &["-c", "1", EMPTY, ONE, TWO, THREE, TEN],
        "tests/expected/all.c1.out",
    )
}

#[test]
fn all_c2() -> TestResult {
    run(
        &["-c", "2", EMPTY, ONE, TWO, THREE, TEN],
        "tests/expected/all.c2.out",
    )
}

#[test]
fn all_c4() -> TestResult {
    run(
